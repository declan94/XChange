...
public class OkexExchange extends BaseExchange {
    ...
    protected void initServices() {
        if (exchangeSpecification.getExchangeSpecificParameters() != null
            ...
            if (exchangeSpecification.getApiKey() != null) {
                this.tradeService = new OkexFuturesTradeService(this, futuresContractOfConfig(), futuresLeverageOfConfig());
            }
        } else {
    ...
    public void remoteInit() throws IOException, ExchangeException {
        if (this.marketDataService instanceof OkexFuturesMarketDataService) {
            activeFuturesInstruments = ((OkexFuturesMarketDataService) marketDataService).getInstruments();
        }
    }
    ...
    private int futuresLeverageOfConfig() {
        ...
        if (exchangeSpecification.getExchangeSpecificParameters().containsKey("Futures_Leverage")) {
            Object leverage = exchangeSpecification.getExchangeSpecificParameters().get("Futures_Leverage");
    ...
    public String determineFuturesInstrumentId(CurrencyPair currencyPair, OkexFuturesPrompt prompt) {
        ...
        throw new ExchangeException("Instrument for "
                + currencyPair
                + " "
                + prompt
