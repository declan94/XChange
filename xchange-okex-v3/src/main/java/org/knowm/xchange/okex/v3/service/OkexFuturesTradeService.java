...
public class OkexFuturesTradeService extends OkexFuturesTradeServiceRaw implements TradeService {
     ...
     */
    public OkexFuturesTradeService(OkexExchange exchange, OkexFuturesPrompt futuresPrompt, int futuresLeverage) {
        super(exchange);
    ...
    public String placeLimitOrder(LimitOrder limitOrder) throws IOException {
        if (instrumentId == null) {
            instrumentId = exchange.determineFuturesInstrumentId(limitOrder.getCurrencyPair(), futuresPrompt);
        }
