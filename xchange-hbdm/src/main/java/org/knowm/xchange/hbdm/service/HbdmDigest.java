...
public class HbdmDigest extends BaseParamsDigest {
  ...
  static HbdmDigest createInstance(String secretKey) {
    return secretKey == null ? null : new HbdmDigest(secretKey);
  }
