...
public class HbdmMarketDataServiceRaw extends HbdmBaseService {
  ...
  public ContractInfo[] getContractInfo(String symbol, HbdmPrompt contractType, String contractCode)
      throws IOException {
    HbdmResult<ContractInfo[]> result =
        hbdm.getContractInfo(
            symbol, contractType == null ? null : contractType.toString(), contractCode);
